...
{
  public static class KustoOutputBindingCSharp1 
  {
    ...
    [FunctionName("KustoOutputBindingCSharp1")]
    public static async Task <CreatedResult> Run(
      ...
      [Kusto(Database: "", // The database to ingest the data into , e.g. functionsdb
            TableName = "", // Table to ingest data into, e.g. Storms
