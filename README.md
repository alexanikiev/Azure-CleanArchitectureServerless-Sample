...
|-------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Domain-Driven Design (DDD)                      | [here](https://martinfowler.com/tags/domain%20driven%20design.html)                                                                                                                                                       |
| Dependency Inversion/Dependency Injection (DI)  | [here](https://learn.microsoft.com/en-us/dotnet/core/extensions/dependency-injection) & [here](https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/architectural-principles#dependency-inversion) |
| Separation of concerns (SoC)                    | [here](https://learn.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/architectural-principles#separation-of-concerns)                                                                                       |
| CQRS (Command-Query-Responsibility-Segregation) | [here](https://learn.microsoft.com/en-us/azure/architecture/patterns/cqrs) & [here](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/microservice-ddd-cqrs-patterns/)                                  |
| Mediator (MediatR)                              | [here](https://github.com/jbogard/MediatR)                                                                                                                                                                                |

Please note that this template is optimized for .NET 6.0 and intended to be deployed in Microsoft Azure Cloud as a Serverless Function Host (Azure Function App) with .NET 6.0 (LTS) Windows runtime. It also leverages .NET Entity Framework (EF) for simplifying data access achieved through its ORM (Object-Relational Mapping) capabilities.
...
Domain Model: A model of the problem space is composed of Entities, Interfaces, Services, etc. Interfaces define contracts for working with domain objects. Everything is the Application (including Infrastructure and Data Access) depends on these interfaces and domain objects.
...
Separation of concerns (SoC): The intent behind Dependency Injection (DI) is to achieve Separation of Concerns (SoC) of construction and use of objects. This can increase code readability and code reuse.
